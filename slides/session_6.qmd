...
*Prediction*: Goal is to minimize out-of-sample prediction error.
...
*Explanation*: Goal: Identify variables associated with the outcome.
Criterion: Parsimony, interpretability.
Interpretation: Coefficients describe associations but not causal effects.

*Causation*: Goal: Estimate causal effects of interventions.
